...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { descricao: @move.descricao, name: @move.name, sentido: @move.sentido, tipo: @move.tipo, user_id: @move.user_id, value: @move.value } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { descricao: @move.descricao, name: @move.name, sentido: @move.sentido, tipo: @move.tipo, user_id: @move.user_id, value: @move.value } }
